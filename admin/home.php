...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color: #6DA4AA;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <div class="login">
        <a href="../logout.php" class="btn btn-outline-light" type="submit">Login</a>
     </div>
      </div>
    </div>
  </div>
...
<div class="container mt-3">
 <p style="color:white">Album :</p>
  ...
  <a href="home.php?AlbumID=<?php echo $row['AlbumID']?>" class="btn btn-outline-primary"><?php echo $row
  ['NamaAlbum']?></a>
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-body">
              <div class="row">
                <div class="col-md-8">
                  <img src="../img/<?php echo $data['LokasiFile']?>" class="card-img-top" title="<?php echo $data['JudulFoto']?>" style="height:13rem width:20rem; border-radius: 10px;">
                </div>
                <div class="col-md-4">
                  <div class="m-2">
